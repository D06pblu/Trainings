...
/*
как известно compareTo соритрует по арифметической разнице между сравниваемыми параметрами
(getWetWeight(), otherMotorcycle.getWetWeight()) - сортировка по возрастанию веса
(otherMotorcycle.getWetWeight(), getWetWeight()) - сортировка по убыванию веса
Т.о.
 */
    @Override
